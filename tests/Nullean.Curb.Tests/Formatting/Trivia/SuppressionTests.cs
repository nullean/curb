...
/// </summary>
/// <remarks>
/// .NET's own mechanism rather than one Curb invented: <c>dotnet format</c> has no ignore comment,
...
public class SuppressionTests : FormattingTest
{
	...
	public Task A_disable_that_is_never_restored_runs_to_the_end_of_the_file() => Unchanged(
		// What the compiler does with an unrestored pragma, so it is what Curb does too.
		"""
		public class C
		{
		#pragma warning disable IDE0055
