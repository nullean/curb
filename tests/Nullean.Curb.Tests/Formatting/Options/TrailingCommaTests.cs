...
/// exact spellings, so a repository that has configured Rider gets the same answer from Curb without
/// having to say it twice. Both are off by default: this is the only thing Curb does that adds or
