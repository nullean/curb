...
/// <remarks>
/// <para>
/// The only transform Kerf performs: everything else it does is layout, and this moves tokens.
...
public class UsingOrderTests : FormattingTest
{
	...
	public Task A_comment_travels_with_the_directive_it_describes() => Formats(
		...
		// comment on System. Kerf keeps each comment with its own directive.
		"""
		// comment on system
		using System;
		// comment on alpha
	...
	public Task A_banner_and_a_comment_together_are_left_alone() => Unchanged(
		...
		// of cut that loses a comment, so Kerf declines the whole file instead.
		editorConfig: "dotnet_sort_system_directives_first = true");
