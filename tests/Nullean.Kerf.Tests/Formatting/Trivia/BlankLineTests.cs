...
/// <summary>
/// Blank lines are the one piece of the author's layout Kerf deliberately keeps. The rule is: at
...
/// a file. Kerf currently drops the latter two, so those tests are skipped and record the gap.
/// </para>
/// </remarks>
