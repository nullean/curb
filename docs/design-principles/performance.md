...
The [twelve-repository comparison](../benchmarks/index.md) has wall-clock numbers across real repositories; on roslyn (17,167 files) {{product}} takes **7 s** against `dotnet format`'s **36 s**.
