---
listing: wrapping
description: "chop_always gives every initializer element its own line; wrap_if_long packs elements instead. Only honoured in deterministic mode. Defaults to `chop_if_long`"
---
...
chop_always gives every initializer element its own line; wrap_if_long packs elements instead. Only honoured in deterministic mode.
