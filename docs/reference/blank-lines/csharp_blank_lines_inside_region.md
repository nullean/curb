---
listing: blank-lines
description: "Blank lines below a #region and above its matching #endregion, forced exactly rather than floored. Defaults to `1`"
---
...
Blank lines below a #region and above its matching #endregion, forced exactly rather than floored.
...
```ini
csharp_blank_lines_inside_region = <value>
```
