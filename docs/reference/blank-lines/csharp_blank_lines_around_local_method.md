---
listing: blank-lines
description: "Blank lines before and after each local function. Defaults to `1`"
---
...
Blank lines before and after each local function.
...
```ini
csharp_blank_lines_around_local_method = <value>
```
