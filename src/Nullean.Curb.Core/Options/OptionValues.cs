...
public static class OptionValues
{
	...
	public static string? Of(in FormatOptions options, string key) => key switch
	{
		...
		"csharp_blank_lines_around_local_method" => Lines(options.BlankLinesAroundLocalMethod),
		...
		"csharp_blank_lines_around_accessor" => Lines(options.BlankLinesAroundAccessor),
		...
		"csharp_blank_lines_inside_namespace" => Lines(options.BlankLinesInsideNamespace),
		"csharp_blank_lines_around_region" => Lines(options.BlankLinesAroundRegion),
		"csharp_blank_lines_inside_region" => Lines(options.BlankLinesInsideRegion),
		...
		"csharp_blank_lines_before_block_statements" => Lines(options.BlankLinesBeforeBlockStatements),
