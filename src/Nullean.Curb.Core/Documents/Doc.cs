...
internal enum DocKind : byte
{
	...
	/// <summary>Text Curb inserts itself. <c>A</c> = index into <see cref="SyntheticText"/>.</summary>
	SynText,
	...
	/// <see cref="SynText"/> because that table is a closed whitelist of the strings Curb may invent,
