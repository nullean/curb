	...
	string SnippetKey)
{
	...
	[
		...
		new("csharp_wrap_object_and_collection_initializer_style", OptionGroup.Wrapping, ["chop_always", "chop_if_long"], "chop_if_long", "chop_always gives every initializer element its own line. Only honoured in deterministic mode.", "object_init"),
		...
		// ---- Suppression (3) ----------------------------------------------------------------
		new("generated_code", OptionGroup.Suppression, ["true", "false"], "false", "Skip this file entirely. Kerf never formats files marked as generated.", "basic_method"),
